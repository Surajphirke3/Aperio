...
from src.api.v1.carbon.routes import router as carbon_router
from src.api.v1.insights.routes import router as insights_router
from src.api.v1.voice.routes import router as voice_router
from src.api.v1.anomalies.routes import router as anomalies_router
