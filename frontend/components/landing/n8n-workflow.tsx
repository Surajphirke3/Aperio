...
const workflowNodes = [
  {
    ...
    icon: Truck,
    color: "#f59e0b",
    description: "Raw recyclable plastics (PET, HDPE, PP) arrive from collection partners, municipal programs, and drop-off centers. Each batch is weighed, photographed, and geo-tagged automatically.",
    stats: { throughput: "5,000 kg/day", sources: "12 Partners" },
    column: 0,
    row: 0,
  },
  {
  ...
  },
  {
    ...
    icon: PackageCheck,
    color: "#14b8a6",
    description: "Certified granules are packaged, labeled with QR-coded traceability data, and shipped to manufacturing partners. Carbon offset certificates are auto-generated per batch.",
