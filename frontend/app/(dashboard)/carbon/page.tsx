    ...
    <div className="min-h-screen">
      ...
      <div className="p-6 space-y-6">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-tf-accent-green/20 to-tf-accent-teal/20 border border-tf-accent-green/30 rounded-xl p-8"
        >
          <div className="flex items-start gap-6">
            <div className="w-16 h-16 rounded-full bg-tf-accent-green/30 flex items-center justify-center flex-shrink-0">
              <Leaf className="w-8 h-8 text-tf-accent-green" />
            </div>
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 mt-6">
                <div className="flex items-center gap-2 text-tf-text-secondary">
                  <Car className="w-5 h-5" />
                  <span className="font-mono">≈ 1.4 cars/year</span>
                </div>
                <Button
                  variant="outline"
                  className="border-tf-accent-green/50 text-tf-accent-green hover:bg-tf-accent-green/20"
                >
